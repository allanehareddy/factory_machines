package com.example.factory_machine.config;
...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, EventRequestDto> consumerFactory() {
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "factory-consumer-group");
        props.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class);
        props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, JsonDeserializer.class);

        JsonDeserializer<EventRequestDto> deserializer =
